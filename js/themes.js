...
export const THEMES = [
  ...
  // ── 13. ROYAL OPERA ── Amethyst and emerald under stage velvet
  {
    id: 'royalopera', name: 'ROYAL OPERA',
    js: {
      PLAYER:0xd14fff, PLAYER_EM:0x6f2488, PLAYER_MK_EM:0x531b66,
      CPU:0x2ce68a, CPU_EM:0x157345, CPU_MK_EM:0x0f5533, CPU_SPEC:0x98ffcb, CPU_LINE:0x5dffb0,
      WIN:0xff5c8e,
      CELL:0x241335, CELL_SPEC:0x594079, CELL_EDGE:0x7c58a6,
      HOVER:0x311742, HOVER_SPEC:0xc064ff, HOVER_EM:0x1b0d26, HOVER_RESET:0x0a0512,
      WHITE:0xffeefb, BG:0x090412,
      LP_EDGE_HI:0xae74d8, LP_EDGE_WF:0x915fba,
    },
    css: {
      'c-player':'#d14fff','c-cpu':'#5dffb0','c-win':'#ff5c8e','c-bg':'#090412',
      'c-white':'#ffeefb','c-sep':'#39224a','c-muted':'#a17db4','c-dim':'#7d5b92',
      'c-panel':'#13091d','c-subtle':'#dbb8ea',
      'c-player-dim':'rgba(209,79,255,0.58)','c-cpu-dim':'rgba(93,255,176,0.6)',
      'c-glow-03':'rgba(255,238,251,0.03)','c-glow-05':'rgba(255,238,251,0.05)',
      'c-glow-08':'rgba(255,238,251,0.08)','c-glow-15':'rgba(255,238,251,0.15)',
      'c-glow-20':'rgba(255,238,251,0.2)','c-glow-30':'rgba(255,238,251,0.3)',
      'c-glow-50':'rgba(255,238,251,0.5)',
      'c-hint':'rgba(255,238,251,0.88)','c-hint-shadow':'rgba(255,238,251,0.16)',
      'c-transparent':'rgba(255,238,251,0)',
    },
  },

  // ── 14. MOROCCO ── Terracotta and zellige teal with rose accents
  {
    id: 'morocco', name: 'MOROCCO',
    js: {
      PLAYER:0xff7a3c, PLAYER_EM:0x8a3f1d, PLAYER_MK_EM:0x662f16,
      CPU:0x19d6c2, CPU_EM:0x0c6f65, CPU_MK_EM:0x09534b, CPU_SPEC:0x92fff2, CPU_LINE:0x53f7e7,
      WIN:0xff4f93,
      CELL:0x1b1730, CELL_SPEC:0x473f70, CELL_EDGE:0x5e5c90,
      HOVER:0x241c3d, HOVER_SPEC:0x9b6fe0, HOVER_EM:0x120f21, HOVER_RESET:0x080610,
      WHITE:0xffefd9, BG:0x090612,
      LP_EDGE_HI:0x8a779c, LP_EDGE_WF:0x736382,
    },
    css: {
      'c-player':'#ff7a3c','c-cpu':'#53f7e7','c-win':'#ff4f93','c-bg':'#090612',
      'c-white':'#ffefd9','c-sep':'#34254a','c-muted':'#9b859d','c-dim':'#7b677e',
      'c-panel':'#140d1f','c-subtle':'#ddbf9e',
      'c-player-dim':'rgba(255,122,60,0.6)','c-cpu-dim':'rgba(83,247,231,0.58)',
      'c-glow-03':'rgba(255,239,217,0.03)','c-glow-05':'rgba(255,239,217,0.05)',
      'c-glow-08':'rgba(255,239,217,0.08)','c-glow-15':'rgba(255,239,217,0.15)',
      'c-glow-20':'rgba(255,239,217,0.2)','c-glow-30':'rgba(255,239,217,0.3)',
      'c-glow-50':'rgba(255,239,217,0.5)',
      'c-hint':'rgba(255,239,217,0.86)','c-hint-shadow':'rgba(255,239,217,0.14)',
      'c-transparent':'rgba(255,239,217,0)',
    },
  },
  ...
  // ── 15. WINE & SAGE ── A softened split-complementary evening palette
  {
    ...
    js: {
      PLAYER:0xe04d8c, PLAYER_EM:0x78274a, PLAYER_MK_EM:0x591d37,
      CPU:0x8fdf7f, CPU_EM:0x477141, CPU_MK_EM:0x355532, CPU_SPEC:0xcdf6c3, CPU_LINE:0xb1f59f,
      WIN:0xffb86a,
      CELL:0x241423, CELL_SPEC:0x563754, CELL_EDGE:0x7a4d72,
      HOVER:0x311a2f, HOVER_SPEC:0xbf62a7, HOVER_EM:0x1a0e19, HOVER_RESET:0x0d070d,
      WHITE:0xfff4ef, BG:0x110712,
      LP_EDGE_HI:0xb56d8f, LP_EDGE_WF:0x965873,
    },
    css: {
      'c-player':'#e04d8c','c-cpu':'#b1f59f','c-win':'#ffb86a','c-bg':'#110712',
      'c-white':'#fff4ef','c-sep':'#3a1c35','c-muted':'#9c7087','c-dim':'#7d5568',
      'c-panel':'#180b17','c-subtle':'#d6b8c7',
      'c-player-dim':'rgba(224,77,140,0.58)','c-cpu-dim':'rgba(177,245,159,0.56)',
      'c-glow-03':'rgba(255,244,239,0.03)','c-glow-05':'rgba(255,244,239,0.05)',
      'c-glow-08':'rgba(255,244,239,0.08)','c-glow-15':'rgba(255,244,239,0.15)',
      'c-glow-20':'rgba(255,244,239,0.2)','c-glow-30':'rgba(255,244,239,0.3)',
      'c-glow-50':'rgba(255,244,239,0.5)',
      'c-hint':'rgba(255,244,239,0.87)','c-hint-shadow':'rgba(255,244,239,0.15)',
      'c-transparent':'rgba(255,244,239,0)',
    },
  },

  // ── 16. AMALFI ── Bougainvillea coral and sea-glass teal on limestone
  {
    id: 'amalfi', name: 'AMALFI',
    js: {
      PLAYER:0xff6f7b, PLAYER_EM:0x883843, PLAYER_MK_EM:0x662a32,
      CPU:0x22c7ac, CPU_EM:0x116658, CPU_MK_EM:0x0d4c42, CPU_SPEC:0xa7ffea, CPU_LINE:0x5ee9d1,
      WIN:0x7b5cff,
      CELL:0xd7d6de, CELL_SPEC:0xa6a4b2, CELL_EDGE:0x8d8aa1,
      HOVER:0xe6dff2, HOVER_SPEC:0xb68cff, HOVER_EM:0xf8f3ff, HOVER_RESET:0xf0ebe6,
      WHITE:0x202733, BG:0xf5efe7,
      LP_EDGE_HI:0xa28cc4, LP_EDGE_WF:0x8b78ad,
    },
    css: {
      'c-player':'#ff6f7b','c-cpu':'#5ee9d1','c-win':'#7b5cff','c-bg':'#f5efe7',
      'c-white':'#202733','c-sep':'#cbc0b7','c-muted':'#857b76','c-dim':'#948982',
      'c-panel':'#e6ddd4','c-subtle':'#5d6170',
      'c-player-dim':'rgba(255,111,123,0.5)','c-cpu-dim':'rgba(94,233,209,0.56)',
      'c-glow-03':'rgba(0,0,0,0.03)','c-glow-05':'rgba(0,0,0,0.05)',
      'c-glow-08':'rgba(0,0,0,0.08)','c-glow-15':'rgba(0,0,0,0.12)',
      'c-glow-20':'rgba(0,0,0,0.15)','c-glow-30':'rgba(0,0,0,0.2)',
      'c-glow-50':'rgba(0,0,0,0.3)',
  ...
  // ── 17. FOUNDRY ── Oxidized mint against burnished copper
  {
    ...
    js: {
      PLAYER:0x34f0c8, PLAYER_EM:0x1a7a66, PLAYER_MK_EM:0x135b4d,
      CPU:0xff8552, CPU_EM:0x7f4227, CPU_MK_EM:0x60311d, CPU_SPEC:0xffc3a3, CPU_LINE:0xffab77,
      WIN:0xffdd57,
      CELL:0x181313, CELL_SPEC:0x453835, CELL_EDGE:0x6a514a,
      HOVER:0x251b1a, HOVER_SPEC:0xd0896d, HOVER_EM:0x140e0d, HOVER_RESET:0x090605,
      WHITE:0xf8ede3, BG:0x080505,
      LP_EDGE_HI:0x967268, LP_EDGE_WF:0x7d5e55,
    },
    css: {
      'c-player':'#34f0c8','c-cpu':'#ffab77','c-win':'#ffdd57','c-bg':'#080505',
      'c-white':'#f8ede3','c-sep':'#2f2320','c-muted':'#967268','c-dim':'#795b54',
      'c-panel':'#120d0c','c-subtle':'#d0a290',
      'c-player-dim':'rgba(52,240,200,0.58)','c-cpu-dim':'rgba(255,171,119,0.58)',
      'c-glow-03':'rgba(248,237,227,0.03)','c-glow-05':'rgba(248,237,227,0.05)',
      'c-glow-08':'rgba(248,237,227,0.08)','c-glow-15':'rgba(248,237,227,0.15)',
      'c-glow-20':'rgba(248,237,227,0.2)','c-glow-30':'rgba(248,237,227,0.3)',
      'c-glow-50':'rgba(248,237,227,0.5)',
      'c-hint':'rgba(248,237,227,0.86)','c-hint-shadow':'rgba(248,237,227,0.14)',
      'c-transparent':'rgba(248,237,227,0)',
    },
  },
