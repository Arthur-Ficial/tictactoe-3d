...
export const THEMES = [
  ...
  },
  {
    ...
    js: {
      PLAYER:0xffffff, PLAYER_EM:0x777777, PLAYER_MK_EM:0x555555,
      CPU:0x666666, CPU_EM:0x333333, CPU_MK_EM:0x222222, CPU_SPEC:0x888888,
      WIN:0xff3333,
      CELL:0x0e0e14, CELL_SPEC:0x2a2a3a, CELL_EDGE:0x3a3a4a,
      HOVER:0x1e1e2e, HOVER_SPEC:0x7777aa, HOVER_EM:0x0e0e1e, HOVER_RESET:0x060608,
      WHITE:0xdddddd, BG:0x020204,
      LP_EDGE_HI:0x6666aa, LP_EDGE_WF:0x555588,
    },
    css: {
      'c-player':'#ffffff','c-cpu':'#666666','c-win':'#ff3333','c-bg':'#020204',
      'c-white':'#ddd','c-sep':'#2a2a2a','c-muted':'#666','c-dim':'#555',
      'c-panel':'#0e0e14','c-subtle':'#999',
      'c-player-dim':'rgba(255,255,255,0.5)','c-cpu-dim':'rgba(102,102,102,0.5)',
      'c-glow-03':'rgba(255,255,255,0.03)','c-glow-05':'rgba(255,255,255,0.05)',
      'c-glow-08':'rgba(255,255,255,0.08)','c-glow-15':'rgba(255,255,255,0.15)',
      'c-glow-20':'rgba(255,255,255,0.2)','c-glow-30':'rgba(255,255,255,0.3)',
      'c-glow-50':'rgba(255,255,255,0.5)',
